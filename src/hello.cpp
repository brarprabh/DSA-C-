...
// public:
//     int data;
//     Node *next; // node type da ptr banaya
// public:
...
// Node *convertarrtoll(vector<int> &arr) // convert arr to linked list
// {
//     Node *head = new Node(arr[0]); // constructor will be called...    // Always keep head..
...
// void printnode(Node *head)  // for printing
// {
//     while (head)
//     {
//         cout << head->data << " ";
...
//         return head; // i think NULL will be there
//     Node *temp = head;
...
//         tail = tail->next;
//     }
//     Node *prev = tail->back;                   // prev hmesha store krna...
//     Node *newNode = new Node(val, tail, prev); // ek link ethe ban gaya
//     tail->back = newNode;                      // doja link ethe ban gya..
//     prev->next = newNode;
//     return head;
// }
